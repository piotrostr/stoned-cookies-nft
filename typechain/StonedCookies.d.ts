...
interface StonedCookiesInterface extends ethers.utils.Interface {
  functions: {
...
export class StonedCookies extends BaseContract {
  ...
  interface: StonedCookiesInterface;
  ...
  callStatic: {
    ...
    setBaseTokenURI(_uri: string, overrides?: CallOverrides): Promise<boolean>;
